...
function acf_course_calculator_shortcode() {
    ...
    <form id="courseCalculator">
        ...
        <div class="form-group my-3" id="rowDiscount" aria-hidden="true">
            ...
            <div class="col-md-6"><div class="price d-flex align-items-baseline justify-content-end"><input class="form-control" id="showDiscount" type="text" value="" readonly /></div></div>
        </div>
        <hr>
